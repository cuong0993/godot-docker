...
RUN apt-get update && apt-get install -y --no-install-recommends \
        ...
        && rm -rf Godot_v${GODOT_VERSION}-${RELEASE_NAME}_mono_linux_headless_64 Godot_v${GODOT_VERSION}-${RELEASE_NAME}_mono_linux_headless_64.zip \
        ...
        # && rm -f Godot_v${GODOT_VERSION}-${RELEASE_NAME}_mono_export_templates.tpz \
